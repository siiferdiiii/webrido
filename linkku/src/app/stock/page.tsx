...
export default function StockPage() {
  ...
  async function handleSaveProduct() {
    ...
    try {
      ...
      setEditProductIdx(null);
      // Auto-select the new/edited product
      setSelectedProduct(productForm);
      setProductTypeFilter(productForm.type);
    } catch (e) { console.error(e); }
  ...
  async function handleDeleteProduct(idx: number) {
    ...
    try {
      ...
      setProducts(updated);
      if (selectedProduct?.id === products[idx].id) {
      ...
      <div className="px-4 md:px-8 pb-8 space-y-5">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-white">Produk</h2>
              <p className="text-xs text-[var(--text-muted)]">Klik produk untuk kelola stok akun di bawah</p>
            </div>
